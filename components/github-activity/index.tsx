    ...
    <Box>
      ...
      >
        <Box sx={{ display: "flex", justifyContent: "space-between" }}>
          <Typography sx={{ color: "#0969DA", fontWeight: "bold" }}>
            login-API
          </Typography>
          <Box
            sx={{
          ...
          >
            <Typography sx={{ fontSize: "12px" }}>Public</Typography>
          </Box>
        </Box>
      </Box> */}
      ...
      >
        ...
        <Box sx={{padding:"10px 0px 20px 0px"}}>
          ...
          >
            <LocationOn sx={{ mr: 1, color: "#000" }} /> Jaffer taiyar society malir Karachi
          </Typography>
          <Typography
            variant="body1"
            sx={{ display: "flex", alignItems: "center", mt: 1 }}
          >
            <Phone sx={{ mr: 1, color: "#000" }} /> +91 22 5555 3345
          </Typography>
          <Typography
            variant="body1"
            sx={{ display: "flex", alignItems: "center", mt: 1 }}
          >
            <Email sx={{ mr: 1, color: "#000" }} /> lagarwal@example.in
          </Typography>
        </Box>
        {/* </Card> */}
        <Typography
        ...
        <Typography sx={{ fontSize: "14px", marginBottom: "10px" }}>
          Experienced full-stack developer proficient in modern web technologies
        ...
        <Typography sx={{ fontSize: "14px", marginBottom: "10px" }}>
          ...
          <br />- MUI, TailwindCSS, Bootstrap
          <br />- MongoDB, PostgreSQL, Firebase
        </Typography>
        ...
        <Typography sx={{ fontSize: "14px", marginBottom: "10px" }}>
          - Software Engineer at XYZ Company (2022 - Present)
          <br />- Web Developer at ABC Solutions (2019 - 2022)
        </Typography>
